...
**VPN** (**V**irtual **P**rivate **N**etwork) - наиболее распространенный способ организации безопасного удаленного доступа пользователям к корпоративным ресурсам за периметром корпоративной сети.

Корпорация Microsoft в своих продуктах Windows и Windows Server поддерживает различные протоколы VPN. В таблице приведены наиболее популярные протоколы, которые используются для организации VPN.

## VPN-протоколы

> Таблица была использована из [статьи на Хабре](https://habr.com/ru/company/dsec/blog/499718/)
...
В качестве альтернативы VPN, Microsoft в Windows 7 и Windows Server 2008 R2 представила альтернативное решение по организации удаленного доступа. Таким решением стала технология DirectAccess.
Технология DirectAccess позволяла использовать безопасное подключение на ПК пользователей к корпоративной сети по протоколу HTTPS (TCP 443) без участия пользователя и установки дополнительных клиентов. Тем самым позволяло организовать двусторонний трафиик между ПК пользователей компании и корпоратвиной сети удаленно. Это позволяло не только пользователю получить доступ к корпоративным ресурсам, но также получить доступ к ПК пользователю удаленно для административных нужд, как если бы он находился в локальной сети.

Но были и свои минусы и сложности данной технологии. В качестве операционной системы необходимо использовать только Enterprise-редакции или Ultimate в Windows 7. Данное решение базировалось на использовании протокола IPv6.

С выходом Windows 10 появилось еще одно решение по организации удаленного доступа пользователям к корпоративным ресурсам - **Always On VPN**.
...
>>>>>>> ea42ceb5a292278d400205c91ec28ccc9b6f67fa
